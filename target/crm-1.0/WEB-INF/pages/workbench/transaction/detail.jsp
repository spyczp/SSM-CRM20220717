				...
				if(response.possibilityList[stage] == 0){
					$.each(response.stageList, function(i, o){
						...
						if(o.orderNo == nowStageNo){
							html += '<span class="glyphicon glyphicon-remove mystage" data-toggle="popover" data-placement="bottom" data-content="'+o.value+'" style="color: red;"></span>';
							html += '-----------';

							//当前阶段之前的阶段，画黑圈，或者黑×。
							//	阶段可能性为0，画黑×，
						}else if(o.orderNo < nowStageNo && response.possibilityList[o.value] == 0){
							html += '<span class="glyphicon glyphicon-remove mystage" data-toggle="popover" data-placement="bottom" data-content="'+o.value+'"></span>';
							html += '-----------';

							//阶段可能性不为0，画黑圈。
						}else if(o.orderNo < nowStageNo && response.possibilityList[o.value] != 0){
							html += '<span class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="'+o.value+'"></span>';
							html += '-----------';
					...
					$.each(response.stageList, function (i, o) {
						//当前阶段画绿标，
						if(o.orderNo == nowStageNo){
							html += '<span class="glyphicon glyphicon-map-marker mystage" data-toggle="popover" data-placement="bottom" data-content="'+o.value+'" style="color: #90F790;"></span>';
							html += '-----------';

							//当前阶段之前的阶段，画绿勾。
						}else if(o.orderNo < nowStageNo){
							html += '<span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" data-content="'+o.value+'" style="color: #90F790;"></span>';
							html += '-----------';
